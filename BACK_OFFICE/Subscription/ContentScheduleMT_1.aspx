<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site3.Master"
    CodeBehind="ContentScheduleMT_1.aspx.vb" Inherits="BACK_OFFICE.ContentScheduleMT" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footerscript" runat="server">
    ...
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
           ...
           datatype: "json",
           url: "../Json/JsonData.asmx/GetJSONData" ,
...
//            colNames: [  'ID', 'Last Sales', 'Name', 'Stock', 'Ship via', 'Notes'],
              colModel: [
                    { name: "Prop1", width: 55 },
                    { name: "Prop2", width: 90 },
                    { name: "Prop3", width: 80, align: "right" }
                ],
//            colModel: [
...
//          groupHeaders:[
//	        {startColumnName: 'name', numberOfColumns: 3, titleText: '<em>Price</em>'} 
//          ]	
//        });
