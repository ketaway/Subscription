...
Public Class DBClass
    ...
    Public Function set_Status_for_Schedule_MT(ByVal CONTENT_SCHEDULE_SUBSERVICE_ID As Integer, ByVal SENT_FILE_NAME As String, strSTatusCode As String) As Boolean
        Dim conn As New DBConnSQL
        conn.DBConnect()
        Dim cmDEL As New SqlCommand
        With cmDEL
            ...
            .Parameters.Add("STATUS_CODE", SqlDbType.VarChar).Value = strSTatusCode
