...
Public Class DBConnSQL
    ...
    Sub New()
        With My.Settings
            ...
            Me._DBServer = .SQLDBHost
            Me._DBName = .SQLDBName
            Me._DBUsername = .SQLDBUsername
            Me._DBPassword = .SQLDBPassword
        End With

        _strconn = "Server=" & DBServer & ";Database=" & _DBName & ";User ID=" & DBUsername & ";Password=" & DBPassword & ";Trusted_Connection=False"
