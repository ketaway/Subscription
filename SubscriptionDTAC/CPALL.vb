Public Class CPALL
    ...
    Public Function Decode_Checking() As Boolean
        ...
        Try
            ...
            'Check Length
            If (textlen > 17 Or textlen < 16) Then
                '_ResultText = False
                SystextCode = ""
    ...
    Public Sub CallStoreProcudureInsertToCPRegister()
        Try
            ...
            Dim oSqlConnection As New Data.SqlClient.SqlConnection("Data Source=192.168.0.21;Initial Catalog=CPALL;User ID=sa;Password=cheeseteam55++")
