Public Class CPALL_711PTT
    ...
    Public Function Decode_Checking() As Boolean
        ...
        Try
            ...
            Else
                ...
                D1 = oCode.Substring(7, 1)
                D2 = oCode.Substring(0, 1)
                ST1 = oCode.Substring(4, 1)
                ST2 = oCode.Substring(2, 1)
                ST3 = oCode.Substring(13, 1)
                ST4 = oCode.Substring(9, 1)
                P = oCode.Substring(11, 1)
                C1 = oCode.Substring(10, 1)
                C2 = oCode.Substring(3, 1)
                C3 = oCode.Substring(12, 1)
                N1 = oCode.Substring(8, 1)
                N2 = oCode.Substring(14, 1)
                N3 = oCode.Substring(6, 1)
                N4 = oCode.Substring(15, 1)
                N5 = oCode.Substring(5, 1)
                N6 = oCode.Substring(1, 1)

                XSum = ST2 * 14 + C2 * 13 + ST1 * 12 + N5 * 11 + N3 * 10 + N1 * 9 + ST4 * 8 + C1 * 7 + P * 6 + C3 * 5 + ST3 * 4 + N2 * 3 + N4 * 2 + N6 * 15
                ...
                Else
                    ...
                    N = N1.ToString + N2.ToString + N3.ToString + N4.ToString + N5.ToString + N6.ToString
    ...
    Public Sub CallStoreProcudureInsertToCPRegister()
        Try
            ...
            Dim oSqlConnection As New Data.SqlClient.SqlConnection("Data Source=192.168.0.21;Initial Catalog=CPALL_711PTT;User ID=sa;Password=cheeseteam55++")
