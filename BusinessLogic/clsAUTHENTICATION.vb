...
#Region "Public Methods"
    Private objAUTHENTICATION_Dal As New DataAccess.T_AUTHENTICATION()
...
#End Region
    ...
    ''' <summary>
    ''' Authen User รวมถึงเช็ค status และ การใส่ Username และ Password ว่าถูกต้องไหม ถ้าไม่ถูกต้อง หรือ ไม่ Active จะได้ Message กลับไปว่าเป็นอะไร
    ''' </summary>
    ''' <param name="strUsername"></param>
    ''' <param name="strPassword"></param>
    ''' <remarks></remarks>
    Public Sub chkAuthen(strUsername As String, strPassword As String)
        If (objAUTHENTICATION_Dal.chkAuthen(strUsername, strPassword)) Then
            objAUTHENTICATION_Dal.getAuthen(objAUTHENTICATION_Dal.Id)
        End If
        setDBField_From_DAL()
