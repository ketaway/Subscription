...
Module Module1
    ...
    Sub Main()
        ...
        'No MSN
        dtBRSchedule = objDB.getBroadcastActiveUserList_TypeL()
        Dim dtDistinct As DataTable = dtBRSchedule.DefaultView.ToTable(True, New String("SubmitrequestID"))


        Dim TypeLFTPFile As String = ""
        For Each drSubID As DataRow In dtDistinct.Rows
            PutFileContent(dtBRSchedule.Select("SubmitrequestID=" + drSubID("SubmitrequestID").ToString), TypeLFTPFile)
            objDB.SetSuccessTypeLProcess(CInt(drSubID("SubmitrequestID").ToString), TypeLFTPFile)
    ...
    End Sub
    Private Sub PutFileContent(ByVal dtBRSchedule() As DataRow, ByRef TypeLFTPFile As String)
        Dim drConFig As DataRow
        Dim MSNList As String = ""
        Dim path As String
