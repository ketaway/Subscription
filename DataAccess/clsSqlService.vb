...
#Region "Contructors"
    Public Sub New()
        _connectionString = My.Settings.ConStr_avi_management
    End Sub
    Public Sub New(db As String)
        If (db = "subscription") Then
            _connectionString = My.Settings.ConStr_Subscription
        ElseIf (db = "avi_management") Then
            _connectionString = My.Settings.ConStr_avi_management
        End If
    End Sub
